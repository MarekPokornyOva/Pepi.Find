...
{
	class PeekableDataReader:IDataReader
	{
		IDataReader _inner;
		internal PeekableDataReader(IDataReader inner) => _inner=inner;

		#region just forwarded members
		...
		#endregion just forwarded members
